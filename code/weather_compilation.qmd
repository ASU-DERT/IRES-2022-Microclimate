...
Last update: 5 April 2026, Heather Throop - updated file locations with config.yml file. The sun and moon icons may not be pulling in correctly on some of the figures - may need updating.
...
fog_humidity_m1_p1 <- weather_phase1_df |>
  ...
  scale_y_continuous(name = "Fog (mm)", 
                     sec.axis = sec_axis(~.*coeff, 
                                         name="Relative Humidity (%)"),expand=c(0,0)) +
...
# save the plot
ggsave(filename = 
       file.path(fig_dir, "Fig2A_microphase1_fog_humidity_plot.jpg"),
       device = "jpeg",
...
# save the plot
ggsave(filename = 
       file.path(fig_dir,"figures", "Fig2_microphase1_weather.jpg"),
       device = "jpeg",
       width = 8, height = 6, dpi = 300)
```
...
fog_humidity_m2_p1 <- weather_phase2_gob_df |>
 ...
 # geom_area(aes(y=Humidity / coeff), fill = "#1b98e0", alpha=0.2) +
  ...
  ylim(0,2) +
  scale_y_continuous(name = "Fog (mm)", 
                     sec.axis = sec_axis(~.*coeff, name="Relative Humidity (%)"),expand=c(0,0)) +
  # Add "A." in upper-left corner
  annotate("text", x = 0, y = Inf, label = "A.", hjust = -0.5, 
           vjust = 1.5, size = 6) +
  xlab("Elapsed Time (hours)") + 
...
# save the plot
ggsave(filename = 
       file.path(fig_dir, "Fig4A_microphase2_fog_humidity_plot.jpg"),
       device = "jpeg",
       width = 8, height = 6, dpi = 300)
```
...
# save the plot
ggsave(filename = 
       file.path(fig_dir, "Fig4_microphase2_weather.jpg"),
       device = "jpeg",
       width = 8, height = 6, dpi = 300)
```
