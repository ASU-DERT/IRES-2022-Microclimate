...
2026-01-29 updated file location to Dropbox (HT)
...
(allfiles = list.files(file.path(DERT_Archives, "NSF_IRES", "2022_Littermicroclimate", "HT_compiled", "data", "KestrelData.L0"), # get a list of all files in folder
...
write_csv(Microphase1_Kestrels_df, file.path(DERT_Archives, "NSF_IRES", "2022_Littermicroclimate", "HT_compiled", "data", "microphase1_Kestrels_L1.csv"))
...
# write the dataframe as a L1 file ready for future analysis and plotting
write_csv(Microphase2_Kestrels_df, file.path(DERT_Archives, "NSF_IRES", "2022_Littermicroclimate", "HT_compiled", "data", "microphase2_Kestrels_L1.csv"))
```
...
ggsave(filename = file.path(DERT_Archives, "NSF_IRES", "2022_Littermicroclimate", 
                            "HT_compiled", "output", "figures", "micro1_Kestrel_T.jpg"),
      plot = micro1_Kestrel_T,
...
# save the plot
ggsave(filename = file.path(DERT_Archives, "NSF_IRES", "2022_Littermicroclimate", 
                            "HT_compiled", "output", "figures", "micro1_Kestrel_RH.jpg"),
      plot = micro1_Kestrel_RH,
       width = 8, height = 6, dpi = 300)
```
...
# save the plot
ggsave(filename = file.path(DERT_Archives, "NSF_IRES", "2022_Littermicroclimate", 
                            "HT_compiled", "output", "figures", "micro2_Kestrel_T.jpg"),
      plot = micro2_Kestrel_T,
       width = 8, height = 6, dpi = 300)
```
...
# Temperature plot
micro2_Kestrel_RH <- ggplot(Microphase2_Kestrels_df, 
                    aes(x = datetime, y = RH, color = KestrelID)) +
  geom_point() +
  labs(title = "Microphase2 Kestrels",
       x = "DateTime",
...
# save the plot
ggsave(filename = file.path(DERT_Archives, "NSF_IRES", "2022_Littermicroclimate", 
                            "HT_compiled", "output", "figures", "micro2_Kestrel_RH.jpg"),
      plot = micro2_Kestrel_RH,
       width = 8, height = 6, dpi = 300)
```
