...
#import dataset
df_microphase2=read.csv(here("data", "microphase2.csv"),header=TRUE) 
...
# remove values of litter moisture greater than 100% o less than 0 
## HT NOTE: CHECK ON THE <100 ... not sure this makes sense
