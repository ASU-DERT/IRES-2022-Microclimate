...
micro1_h_above_15pct_moisture <- micro1_means |>
  select(TYPE, Rainfall, elapsed_time, LitterMoisture_mean) |>
...
plot_df <- micro1_h_above_15pct_moisture |>
  select(TYPE, Rainfall, hours_above_15_0_24, hours_above_15_24_48) |>
  pivot_longer(
...
micro2_h_above_15pct_moisture <- micro2_means |>
  select(DEPTH, Rainfall, elapsed_time, LitterMoisture_mean) |>
