...
micro1_litter_p2 <- micro1_means |>
  ...
  geom_vline(xintercept = c(33, 44), linetype = "dashed", 
  ...
  annotate("rect", xmin = night1_start_m1, xmax = night1_end_m1, 
           ymin = -5, ymax = Inf, alpha = 0.2, fill = "grey") +
  ...
  annotation_custom(moon_img, xmin = 7, xmax = 19, ymin = 136, ymax = 148) +
  annotation_custom(moon_img, xmin = 31, xmax = 43, ymin = 136, ymax = 148) +
