...
# save plot
ggsave(filename = file.path(fig_dir, "microphase1_pct_time_wet_grouped.jpg"),
...
facet_grid(. ~ DEPTH,
  ...
  scale_fill_manual(
    ...
    labels = c("0" = "No addition", "5" = "5 mm addition", "10" = "10 mm addition")
    ) +
  labs(x = "Time", y = "Time above moisture threshold (%)") +
...
# save plot
ggsave(filename = file.path(fig_dir, "microphase2_pct_time_moist_by_day.jpg"),
